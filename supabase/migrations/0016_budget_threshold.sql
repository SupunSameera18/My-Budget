...
BEGIN
  FOR v_budget IN
    SELECT * FROM public.budgets WHERE archived_at IS NULL
  LOOP
    ...
    -- Skip custom-period budgets where today is outside the period
...
-- pg_cron: run the sweep at the start of every hour (UTC)
