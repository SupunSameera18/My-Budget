...
export default async function OnboardingPage() {
  ...
  if (onboarding_step <= 1) redirect("/onboarding/currency");
  if (onboarding_step === 2) redirect("/onboarding/account");
  if (onboarding_step === 3) redirect("/onboarding/categories");

  // step=4 but onboarding_completed_at is null (stale state) — re-trigger final step
